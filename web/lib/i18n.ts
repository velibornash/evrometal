...
export const dictionary = {
  sr: {
    ...
    categories: {
      eyebrow: "Kategorije",
      title: "Sistemi spremni za specifikaciju",
      items: [
    ...
    products: {
      ...
      text:
        "Katalog prikazuje proizvode iz Sanity CMS-a. Za svaki proizvod moguće je dodati fotografije, opis, tehničke karakteristike i prateću dokumentaciju.",
      count: "artikala iz Sanity CMS-a",
      filters: ["Sve", "ALU", "PVC"],
      empty: "Trenutno nema objavljenih proizvoda.",
      fallback: "Tehnički sistem dostupan za projektnu specifikaciju i B2B upite.",
    ...
    contact: {
      ...
      title: "Pošaljite zahtev za ponudu, specifikaciju ili B2B saradnju.",
      text:
    ...
    productPage: {
      ...
      fallback: "Tehnički sistem dostupan za projektnu specifikaciju, proizvodnju, isporuku i B2B upite.",
      quote: "Zatraži ponudu",
      call: "Pozovi prodaju",
      cards: [
